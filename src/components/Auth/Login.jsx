...
export default class Login extends React.Component {
      ...
      .catch((action) => {
        ...
        if (error.toLowerCase().indexOf("unauthorized") > -1) {
          new Promise((resolve, reject) => {
            ...
            .then(() => {
              this.nameSubmit({ login, username });
            })
  ...
  renderForm = (formProps) => {
    ...
    return (
      <View>
        <Button
          onPress={() => this.nameSubmit({ login:"matt@matt.com", username:"matt"})}
          title="Login as Matt"
          color="#841584"
        />
        <Button
          onPress={() => this.nameSubmit({ login:"ben@ben.com", username:"ben"})}
          title="Login as Ben"
          color="#841584"
        />
      </View>
